(() => {
  ...
  if (/firefox/i.test(navigator.userAgent)) {
    ...
    window.getComputedStyle = (el, pseudoEl) => {
      const t = getComputedStyle2(el, pseudoEl);
  ...
  Object.assign(player_default.prototype, {
    ...
    buildprogress(player, controls, layers, media) {
      ...
      let handleMouseMove = (e) => {
        const totalStyles = getComputedStyle(t.total), offsetStyles = offset(t.total), width = t.total.offsetWidth, transform = (() => {
          if (totalStyles.webkitTransform !== void 0) {
            return "webkitTransform";
          } else if (totalStyles.mozTransform !== void 0) {
            return "mozTransform ";
          } else if (totalStyles.oTransform !== void 0) {
            return "oTransform";
          } else if (totalStyles.msTransform !== void 0) {
            return "msTransform";
          } else {
            return "transform";
          }
        ...
        if (t.getDuration()) {
          ...
          if (!IS_IOS && !IS_ANDROID) {
            ...
            if (t.options.useSmoothHover && cssMatrix !== null && typeof window[cssMatrix] !== "undefined") {
              const matrix = new window[cssMatrix](getComputedStyle(t.handle)[transform]), handleLocation = matrix.m41, hoverScaleX = pos / parseFloat(getComputedStyle(t.total).width) - handleLocation / parseFloat(getComputedStyle(t.total).width);
